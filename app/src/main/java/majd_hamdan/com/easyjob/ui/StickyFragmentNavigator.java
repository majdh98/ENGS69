...
/**
 * https://androidx.tech/artifacts/navigation/navigation-fragment/2.3.3-source/androidx/navigation/fragment/FragmentNavigator.java.html
 */
...
public class StickyFragmentNavigator extends Navigator<StickyFragmentNavigator.Destination> {
    ...
    public StickyFragmentNavigator(Context mContext, FragmentManager mFragmentManager, int mContainerId) {
